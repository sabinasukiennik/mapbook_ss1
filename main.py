...
ramka_formluarz=Frame(root)
ramka_szczegoly_obiektow=Frame(root)
ramka_mapa=Frame(root)

ramka_lista_obiektow.grid(row=0, column=0)
ramka_formluarz.grid(row=0, column=1)
...
#RAMKA FORMULARZ
label_formluarz= Label(ramka_formluarz, text="Formluarz: ")
label_formluarz.grid(row=0, column=0, columnspan=2)
label_name= Label(ramka_formluarz, text="Imię: ")
label_name.grid(row=1, column=0, sticky=W)
label_surname= Label(ramka_formluarz, text="Nazwisko: ")
label_surname.grid(row=2, column=0, sticky=W)
label_post= Label(ramka_formluarz, text="Liczba postów: ")
label_post.grid(row=3, column=0, sticky=W)
label_location= Label(ramka_formluarz, text="Miejscowość: ")
label_location.grid(row=4, column=0, sticky=W)

entry_name= Entry(ramka_formluarz)
entry_name.grid(row=1, column=1)
entry_surname= Entry(ramka_formluarz)
entry_surname.grid(row=2, column=1)
entry_post= Entry(ramka_formluarz)
entry_post.grid(row=3, column=1)
entry_location= Entry(ramka_formluarz)
entry_location.grid(row=4, column=1)

button_dodaj_obiekt=Button(ramka_formluarz, text="Dodaj")
button_dodaj_obiekt.grid(row=5, column=1, columnspan=2)

#RAMKA SZCZEGÓŁY OBIEKTÓW
label_szczegoly_obiektu= Label(ramka_szczegoly_obiektow, text="Szcegóły uzytkownika: " )
